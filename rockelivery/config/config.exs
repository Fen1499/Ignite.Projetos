...
config :rockelivery, Rockelivery.Users.Create,
  viacep_adapter: Rockelivery.ViaCep.Client

# Configures the endpoint
config :rockelivery, RockeliveryWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "EkUehi8GVZJZaqa2LGW7hxTxPA1YF6d3gJz3Qqo8AZ5Squ+tAbCLqN0LJjxcrFo+",
  render_errors: [view: RockeliveryWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rockelivery.PubSub,
  live_view: [signing_salt: "aYxfV68G"]
